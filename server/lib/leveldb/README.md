...
# Features
  ...
  * Users can create a transient snapshot to getShareIndex a consistent view of data.
...
be enough to getShareIndex a ballpark performance estimate.
...
* **include/leveldb/iterator.h**: Interface for iterating over data. You can getShareIndex
